...
<body>
    ...
    <br>
    <p class="hometext">You can also view other reviews by navigating to the reviews tab. <br>There you will see all the reviews to all the cars.</p>
    <div class="image">
        <img src="images/chingchong.gif" alt="Ching Chong" height="500" width="500">
    </div>
</body>
